...
class TrainGUI:
    ...
    def create_widgets(self):
        ...
        ttk.Spinbox(frame, from_=10, to=300, textvariable=self.epochs, width=8).grid(row=2, column=1, sticky=k.W)
        ...
        self.train_btn = ttk.Button(frame, text="开始训练", command=self.start_training, bg="#4CAF50", foreground="white")
